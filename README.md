...
| Email | hMailServer IMAP/SMTP + RainLoop webmail (completed) | [docs/email/](./docs/email/) |
| ITSM / CMDB | GLPI ticketing, asset inventory (files created, implementation pending) | [docs/itsm/](./docs/itsm/) |
...
| Troubleshooting | Issues solved in the lab (agent disconnected, SSH attacks, RainLoop auth) | [docs/troubleshooting/](./docs/troubleshooting/) |
...
| AD User Deleted | [T1531](https://attack.mitre.org/techniques/T1531/) | [121-ad-user-deleted.xml](./monitoring/wazuh-rules/windows/121-ad-user-deleted.xml) |
| AD Group Modified | [T1098](https://attack.mitre.org/techniques/T1098/) | [122-ad-group-modified.xml](./monitoring/wazuh-rules/windows/122-ad-group-modified.xml) |
| AD Login Anomaly | [T1078](https://attack.mitre.org/techniques/T1078/) | [123-ad-login-anomaly.xml](./monitoring/wazuh-rules/windows/123-ad-login-anomaly.xml) |
...
- Email Setup: hMailServer + RainLoop configuration → [hMailServer-setup-on-DC01.md](./docs/email/hMailServer-setup-on-DC01.md) | [rainloop-setup.md](./docs/email/rainloop-setup.md)
...
- RainLoop Auth Bug: Short login incompatibility with hMailServer → [rainloop-short-login-authentication-problem.md](./docs/troubleshooting/rainloop-short-login-authentication-problem.md)
...
- Wazuh agent installation on DC01 + custom detection rules
- Email management: hMailServer on DC01 + RainLoop via Docker
- Linux endpoint joined to Active Directory (Ubuntu + realmd/sssd)
- Troubleshooting documentation for common issues

🟡 In Progress
- GLPI deployment and initial configuration (files created, pending Docker setup)
- Advanced attack scenario documentation (Kerberoasting, DCSync, Golden Ticket)
